...
export const EFFECTS: StatusEffectDef[] = [
  ...
  /* ---------------- mind ---------------- */
  {
    id: 'enraged',
    label: 'Rage',
    desc: 'Working like they want to break something. Fast, reckless, and dangerous to be near.',
    tone: 'bad',
    workSpeed: 1.3,
    moveSpeed: 1.1,
    accident: 2.4,
    ...
    moralePerHour: -2,
    learnRate: 0.6,
    conflicts: ['despair', 'breakingDown', 'content'],
    marker: '💢',
  },
  {
    id: 'breakingDown',
    label: 'Breaking Down',
    desc: 'Has stopped listening. Barely works, wanders off, and needs people around them.',
    tone: 'bad',
    conditional: true,
    workSpeed: 0.22,
    moveSpeed: 0.85,
    ...
    moralePerHour: -2.5,
    accident: 1.6,
    conflicts: ['content', 'enraged'],
    marker: '😵',
  },
  {
    id: 'despair',
    label: 'Despair',
    desc: 'Going through the motions with nothing left in the tank.',
    tone: 'bad',
    conditional: true,
    workSpeed: 0.72,
    learnRate: 0.6,
  ...
  },
  {
    id: 'panicked',
    label: 'Panicked',
    desc: 'Running on fear. Quick on their feet, no use at anything careful.',
    tone: 'bad',
    workSpeed: 0.42,
    moveSpeed: 1.35,
    accident: 1.9,
  ...
  },
  {
    id: 'paranoid',
    label: 'On Edge',
    desc: 'Keeps looking over their shoulder. Sleeps badly, snaps easily.',
    tone: 'bad',
    fatigue: 1.25,
    workSpeed: 0.9,
    moralePerHour: -0.8,
  },
  {
    id: 'focused',
    label: 'In the Zone',
    desc: 'Deep in the work and losing track of the day. Everything clicks.',
    tone: 'good',
    workSpeed: 1.22,
    learnRate: 1.4,
    moralePerHour: 0.8,
  },
  {
    id: 'emboldened',
    label: 'Emboldened',
    desc: 'A win under their belt. Steadier hands and a straighter back.',
    tone: 'good',
    workSpeed: 1.1,
    vulnerability: 0.85,
    moralePerHour: 1,
  },
  {
    id: 'secondWind',
    label: 'Second Wind',
    desc: 'Found something extra. Tires far more slowly for a while.',
    tone: 'good',
    fatigue: 0.55,
    workSpeed: 1.08,
  },
  ...
  /* ---------------- body ---------------- */
  {
    id: 'parched',
    label: 'Parched',
    desc: 'No water in the stores and it shows. Slow, headachy work.',
    tone: 'bad',
    conditional: true,
    workSpeed: 0.78,
    fatigue: 1.3,
  ...
  },
  {
    id: 'queasy',
    label: 'Queasy',
    desc: 'Something they ate. It will pass, but not pleasantly.',
    tone: 'bad',
    workSpeed: 0.82,
    healthPerHour: -0.4,
    hungerRate: 0.7,
  ...
  {
    id: 'blistered',
    label: 'Blistered Hands',
    desc: 'Too long swinging tools they do not have. Everything stings.',
    tone: 'bad',
    workSpeed: 0.85,
    accident: 1.3,
  },
