...
export interface BuildingDef {
  ...
  minLevel?: number;
  /**
   * How many of this structure the settlement may have at once (counting
   * blueprints). Omitted means unlimited — paths, walls and beds.
   */
  maxCount?: number;
  ...
  upgradeTo?: string;
  /**
   * Reached by upgrading the tier below rather than by placing it. Keeps the
   * settlement improving what it has instead of sprawling.
   */
  upgradeOnly?: boolean;
